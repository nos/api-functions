...
var getLastBlock = function getLastBlock(fallback) {
  return (0, _executor.default)("getLastBlock", fallback);
};
/**
 * @function claimGas
 * @param {function} fallback fallback function if outside of nOS browser
...
var getPublicKey = function getPublicKey(config, fallback) {
  return (0, _executor.default)("getPublicKey", fallback, config);
};
/**
 * @function encrypt
 * @param {object} config All possible arguments and flags are passed as childs of this object
...
var encrypt = function encrypt(config, fallback) {
  return (0, _executor.default)("encrypt", fallback, config);
};
/**
 * @function decrypt
 * @param {object} config All possible arguments and flags are passed as childs of this object
...
var decrypt = function decrypt(config, fallback) {
  return (0, _executor.default)("decrypt", fallback, config);
};
